...
import com.dofun.sxl.http.httputil.DefaultSSLSocketFactory;
import com.dofun.sxl.http.httputil.GZipDecompressingEntity;
import com.dofun.sxl.http.httputil.HttpCache;
import com.dofun.sxl.http.httputil.HttpHandler;
import com.dofun.sxl.http.httputil.HttpRedirectHandler;
import com.dofun.sxl.http.httputil.HttpRequest;
import com.dofun.sxl.http.httputil.OtherUtils;
import com.dofun.sxl.http.httputil.PriorityExecutor;
import com.dofun.sxl.http.httputil.RequestCallBack;
import com.dofun.sxl.http.httputil.RequestParams;
import com.dofun.sxl.http.httputil.ResponseStream;
import com.dofun.sxl.http.httputil.RetryHandler;
import com.dofun.sxl.http.httputil.SyncHttpHandler;
...
public class HttpUtils {
    ...
    public ResponseStream sendSync(HttpRequest.HttpMethod method, String url) throws HttpException, com.dofun.sxl.http.httputil.HttpException {
        return sendSync(method, url, null);
    }

    public ResponseStream sendSync(HttpRequest.HttpMethod method, String url, RequestParams params) throws org.apache.http.HttpException, com.dofun.sxl.http.httputil.HttpException {
        if (url == null)
            throw new IllegalArgumentException("url may not be null");
    ...
    private ResponseStream sendSyncRequest(HttpRequest request, RequestParams params) throws com.dofun.sxl.http.httputil.HttpException {
